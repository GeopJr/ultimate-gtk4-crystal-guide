<script>
	...
	import { Button, ClickableTile, Grid, Row, Column } from 'carbon-components-svelte';
	...
	<Grid padding class="sp--grid">
		<Row>
			<Column style="text-align: center;">
				...
				<h2 class="subTitle">Learn how to create premium GTK4 apps in Crystal</h2>
				<Button
					icon={ArrowRight32}
					size="lg"
	...
	<Grid padding>
		<Row class="sp--header--tiles">
			...
			<Column md sm={breakpoints.sm}>
				<ClickableTile
					href="/guide.epub"
					class="sp--tile"><h2 class="tile--title">Download as EPUB</h2></ClickableTile
				>
			</Column>
		</Row>
	</Grid>
